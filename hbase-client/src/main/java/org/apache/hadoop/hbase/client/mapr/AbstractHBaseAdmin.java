...
public abstract class AbstractHBaseAdmin implements Closeable {
  ...
  public boolean enableCatalogJanitor(boolean enable)
    ...
    LOG.warn("enableCatalogJanitor() called for MapR, silently ignoring.");
    return false;
  }

  public int runCatalogScan()
    throws ServiceException, MasterNotRunningException {
    LOG.warn("runCatalogScan() called for MapR, silently ignoring.");
    return 0;
  }

  public boolean isCatalogJanitorEnabled()
    throws ServiceException, MasterNotRunningException {
    LOG.warn("isCatalogJanitorEnabled() called for MapR, silently ignoring.");
    return false;
  }
